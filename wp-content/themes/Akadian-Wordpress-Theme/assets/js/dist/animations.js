...
(() => { // webpackBootstrap
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var containerAnimations = document.querySelectorAll(".animation-container");
            if (containerAnimations !== null) {
                containerAnimations.forEach(function(container) {
                    var containerElements = container.querySelectorAll(".animation-element");
                    if (containerElements.length > 0) {
                        containerElements.forEach(function(containerElement) {
                            gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(containerElement, {
                                translateY: 0,
                                translateX: 0,
                                opacity: 1,
                                scrollTrigger: {
                                ...
                                // add class animated to the element
                                onComplete: function onComplete() {
            ...
            //Modal Scroll Trigger for PDF Block
            var pdfModal = document.getElementById("info-modal");
            var pdfBlock = document.getElementById("pdf-block");
            if (pdfModal !== null) {
                gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(pdfModal, {
                    translateY: "120%",
                    duration: 0.2,
                    ease: "ease",
                    scrollTrigger: {
            ...
            var anchorLinks = document.querySelectorAll(".anchor-link-tabs a");
            if (anchorLinks !== null) {
                anchorLinks.forEach(function(anchor) {
                    var anchorTarget = document.getElementById(anchor.dataset.target);
                    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(anchor, {
                        scrollTrigger: {
                            trigger: anchorTarget,
                            start: "top 50%",
                            end: "bottom 50%",
                            scrub: true,
                            toggleClass: {
